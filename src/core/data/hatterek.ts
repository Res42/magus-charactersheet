...
export const Hatterek = {
  ...
  Adottsagok: {
    ...
    Intelligencia1: { nev: 'Adottság (Intelligencia 1)', kap: 1, tulajdonsag: TulajdonsagType.Intelligencia } as Adottsag,
    Intelligencia2: { nev: 'Adottság (Intelligencia 2)', kap: 2, tulajdonsag: TulajdonsagType.Intelligencia } as Adottsag,
    Intelligencia3: { nev: 'Adottság (Intelligencia 3)', kap: 3, tulajdonsag: TulajdonsagType.Intelligencia } as Adottsag,
    Intelligencia4: { nev: 'Adottság (Intelligencia 4)', kap: 3, tulajdonsag: TulajdonsagType.Intelligencia } as Adottsag,
